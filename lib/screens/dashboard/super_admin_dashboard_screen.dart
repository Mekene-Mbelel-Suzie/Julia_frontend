      ...
      child: Column(
        ...
        children: [
          WelcomeBanner(
            ...
            subtitle:
            'Manage hospitals, users, vaccines, and schedules from one control center.',
          ),
          ...
          if (_loading)
            ...
            Wrap(
              ...
              children: [
                _KpiCard(
                  'Hospitals',
                  _stats!.hospitalsCount,
                  Icons.local_hospital_rounded,
                  const Color(0xFF1565C0),
                ),
                _KpiCard(
                  'Admins',
                  _stats!.hospitalAdminsCount,
                ...
                _KpiCard(
                  'Children',
                  _stats!.childrenCount,
                  Icons.child_care_rounded,
                  const Color(0xFFAD1457),
                ),
                _KpiCard(
                  'Vaccines',
                  _stats!.vaccinesCount,
              ...
              builder: (context, c) {
                ...
                final tables = [
                  _RecentTable(
                    ...
                    columns: const ['Name', 'City', 'Users'],
                    rows: _stats!.recentHospitals
                        .map((h) => [h.name, h.city ?? '—', '${h.usersCount}'])
                        .toList(),
                    isLight: isLight,
                  ),
                  _RecentTable(
                    ...
                    rows: _stats!.recentUsers
                        .map((u) => [u.fullName, u.email, u.role])
                        .toList(),
                    isLight: isLight,
                  ),
                ];
